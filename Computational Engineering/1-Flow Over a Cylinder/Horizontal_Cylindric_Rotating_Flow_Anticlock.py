...
forces_file = f"Results/Anticlock/ForcesA_{N}x{M}.txt"
...
# Write the results forces
circulation_file = f"Results/Anticlock/CirculationA_{N}x{M}.txt"
...
# Generate the plot
#=======================================
output_plot1 = f"Results/Anticlock/Anticlock_SL_{N}x{M}.pdf"
output_plot2 = f"Results/Anticlock/Anticlock_Vel_{N}x{M}.pdf"
output_plot3 = f"Results/Anticlock/Anticlock_Temp_{N}x{M}.pdf"
output_plot4 = f"Results/Anticlock/Anticlock_Press_{N}x{M}.pdf"
print(" ")
print("=================")
