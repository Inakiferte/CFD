#=======================================
# Code for the Diagonal Flow UDS
...
N         = 20                             # Control volumes in x direction.
...
# Generate the plot
#=======================================
output_plot1 = f"Results/Diagonal/Phi_{N}x{M}_{Pe}.pdf"
output_plot2 = f"Results/Diagonal/Vel_{N}x{M}_{Pe}.pdf"
output_plot3 = f"Results/Diagonal/Phi3D_{N}x{M}_{Pe}.pdf"
print(" ")
print("=================")
