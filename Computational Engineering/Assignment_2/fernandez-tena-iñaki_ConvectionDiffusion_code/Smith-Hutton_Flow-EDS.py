#=======================================
# Code for the Smith-Hutton Case EDS
...
# Path to output file
file_output = f"Results/S-H/Outlet_{N}x{M}_{rhoGamma}-EDS.dat"
...
# Generate the plot
#=======================================
output_plot1 = f"Results/S-H/Phi_{N}x{M}_{rhoGamma}-EDS.pdf"
output_plot2 = f"Results/S-H/Vel_{N}x{M}_{rhoGamma}-EDS.pdf"
output_plot3 = f"Results/S-H/Phi3D_{N}x{M}_{rhoGamma}-EDS.pdf"
print(" ")
print("=================")
