...
N         = 171                             # Control volumes in x direction. Odd number!
M         = 171                            # Control volumes in y direction. Odd number!
...
psi_body  = psi_T / 2.0 - 1.25                   # Stream function inside the body
# Mesh generation
...
forces_file = f"Results/Clock/ForcesC_{N}x{M}.txt"
...
# Write the results forces
circulation_file = f"Results/Clock/CirculationC_{N}x{M}.txt"
with open(circulation_file, 'w') as file:
    file.write("=================\n")
    file.write(f' The circulation over the cylinder is {circ} m^2 / s')

#=======================================
# Generate the plot
#=======================================
output_plot1 = f"Results/Clock/Clock_SL_{N}x{M}.pdf"
output_plot2 = f"Results/Clock/Clock_Vel_{N}x{M}.pdf"
output_plot3 = f"Results/Clock/Clock_Temp_{N}x{M}.pdf"
output_plot4 = f"Results/Clock/Clock_Pres_{N}x{M}.pdf"
print(" ")
print("=================")
...
#plt.imshow(v_P, cmap= 'inferno', extent=(x_p.min(), x_p.max(), y_p.min(), y_p.max()))
#plt.colorbar()
